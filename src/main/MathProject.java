...
//        clearScreen();
    ...
    public static int ejemplo1_desition1(int numeroN){
        //caso base
    if(numeroN == 1){
    ...
    // paso inductivo
    int result = numeroN + ejemplo1_desition1(numeroN - 1);
    System.out.println("Su resultado es " + result);
    return result;
}
    public static void logicaEjemplo1(){
            System.out.print("ingrese los primeros 𝓷 numeros que desea sumar: ");
            numeroN = sc.nextInt();
            ejemplo1_desition1(numeroN);
    }
